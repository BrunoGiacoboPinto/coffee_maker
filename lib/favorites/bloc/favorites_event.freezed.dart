...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( FetchFavoritesEvent value)?  fetchFavorites,TResult Function( ToggleFavoriteEvent value)?  toggleFavorite,TResult Function( PhotosUpdatedEvent value)?  photosUpdated,required TResult orElse(),}){
final _that = this;
switch (_that) {
case FetchFavoritesEvent() when fetchFavorites != null:
return fetchFavorites(_that);case ToggleFavoriteEvent() when toggleFavorite != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( FetchFavoritesEvent value)  fetchFavorites,required TResult Function( ToggleFavoriteEvent value)  toggleFavorite,required TResult Function( PhotosUpdatedEvent value)  photosUpdated,}){
final _that = this;
switch (_that) {
case FetchFavoritesEvent():
return fetchFavorites(_that);case ToggleFavoriteEvent():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( FetchFavoritesEvent value)?  fetchFavorites,TResult? Function( ToggleFavoriteEvent value)?  toggleFavorite,TResult? Function( PhotosUpdatedEvent value)?  photosUpdated,}){
final _that = this;
switch (_that) {
case FetchFavoritesEvent() when fetchFavorites != null:
return fetchFavorites(_that);case ToggleFavoriteEvent() when toggleFavorite != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchFavorites,TResult Function( String id)?  toggleFavorite,TResult Function( List<CoffeePhotoData> photos)?  photosUpdated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case FetchFavoritesEvent() when fetchFavorites != null:
return fetchFavorites();case ToggleFavoriteEvent() when toggleFavorite != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchFavorites,required TResult Function( String id)  toggleFavorite,required TResult Function( List<CoffeePhotoData> photos)  photosUpdated,}) {final _that = this;
switch (_that) {
case FetchFavoritesEvent():
return fetchFavorites();case ToggleFavoriteEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchFavorites,TResult? Function( String id)?  toggleFavorite,TResult? Function( List<CoffeePhotoData> photos)?  photosUpdated,}) {final _that = this;
switch (_that) {
case FetchFavoritesEvent() when fetchFavorites != null:
return fetchFavorites();case ToggleFavoriteEvent() when toggleFavorite != null:
return toggleFavorite(_that.id);case PhotosUpdatedEvent() when photosUpdated != null:
...
class FetchFavoritesEvent implements FavoritesEvent {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FetchFavoritesEvent);
}
...
class ToggleFavoriteEvent implements FavoritesEvent {
...
@override
String toString() {
  return 'FavoritesEvent.toggleFavorite(id: $id)';
}
...
/// @nodoc
abstract mixin class $ToggleFavoriteEventCopyWith<$Res> implements $FavoritesEventCopyWith<$Res> {
...
class PhotosUpdatedEvent implements FavoritesEvent {
...
@override
String toString() {
  return 'FavoritesEvent.photosUpdated(photos: $photos)';
}
...
/// @nodoc
abstract mixin class $PhotosUpdatedEventCopyWith<$Res> implements $FavoritesEventCopyWith<$Res> {
